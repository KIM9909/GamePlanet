...
public class CustomCardService {
	...
	@Transactional
	public CustomTelepathyCardResponse createTelepathyCard(Integer customId, CustomTelepathyCardRequest request) {
	...
	public List<CustomSeedcardResponse> findAllSeedCard(Integer customId) {
		 List<CardEntity> customCardEntity = customCardJpaRepository.findAllSeedCard(customId, "SEED_CERTIFICATE_CARD");
	...
	public List<CustomTelepathyCardResponse> findAllTelepathyCards(Integer customId) {
		List<CardEntity> customCardEntity = customCardJpaRepository.findAllSeedCard(customId, "TELEPATHY_CARD");
		return customCardEntity.stream()
	...
	public List<CustomNeuronValleyCardResponse> findAllNeuronValleyCards(Integer customId) {
		List<CardEntity> customCardEntity = customCardJpaRepository.findAllSeedCard(customId, "NEURONS_VALLEY_CARD");
		return customCardEntity.stream()
	...
	public CustomCardResponse update(CustomCardId id, CustomCardRequest request) {
		CardEntity cardEntity = customCardJpaRepository.findByCardIdAndCustomElement_CustomId(id.getCardId(), id.getCustomId()).orElseThrow();
