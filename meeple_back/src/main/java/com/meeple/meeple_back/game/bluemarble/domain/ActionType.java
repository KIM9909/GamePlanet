...
public enum ActionType {
	ROLL_DICE("ROLL_DICE"), PAY_TOLL("PAY_TOLL"), BUY_LAND("BUY_LAND"), GAME_END("GAME_END"), USE_CARD(
			...
			"BUILD_BASE"
	), DO_YOU_WANT_TO_BUILD_THE_BASE("DO_YOU_WANT_TO_BUILD_THE_BASE"), DRAW_CARD("DRAW_CARD"), TURN_END("TURN_END"), DOUBLE_DICE("DOUBLE_DICE"), CHECK_END("CHECK_END"), CHOOSE_POSITION("CHOOSE_POSITION");
