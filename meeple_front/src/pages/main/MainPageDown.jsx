...
export const MainPageDown = ({ isFirstSection, onRegisterClick }) => {
  ...
  return (
    ...
    >
      {!token && <div className="absolute inset-0 backdrop-blur-sm bg-black/30" />}
      ...
      <div className="relative z-10 w-full max-w-7xl px-8">
        {!token ? (
          ...
          <div className="flex justify-between items-center">
            <div className={`flex flex-col items-start relative transition-all duration-1000 
              ...
              <img 
                ...
                className={`absolute left-[0px] top-5 w-[110px] h-auto transition-all duration-1000 ease-bounce
                  ${showContent ? 'opacity-100 translate-y-0 rotate-12' : 'opacity-0 -translate-y-full rotate-0'}`}
              ...
              <img 
                ...
                className={`absolute right-[400px] top-[180px] w-[110px] h-auto transition-all duration-1000 ease-bounce
                  ${showContent ? 'opacity-100 translate-y-0 rotate-[150deg]' : 'opacity-0 -translate-y-full rotate-0'}`}
              ...
              <img 
                ...
                className={`absolute -left-5 bottom-3 w-[110px] h-auto transition-all duration-1000 ease-bounce
                  ${showContent ? 'opacity-100 translate-y-0 rotate-[43deg]' : 'opacity-0 -translate-y-full rotate-0'}`}
            ...
            <button
              ...
              className={`group relative w-52 px-8 py-6 text-5xl font-bold text-white 
                        ...
                        hover:scale-105
                        mr-40 mt-20
                        ${showButtons ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}
              style={{
                boxShadow: `
