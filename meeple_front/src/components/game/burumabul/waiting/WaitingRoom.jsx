...
const WaitingRoom = () => {
  ...
  return (
    <>
      ...
      >
        <div className="h-[90%] w-[75%] bg-white bg-opacity-70 rounded-lg flex flex-col justify-start items-center">
          {/* 친구 검색해서 친구 추가 */}
          <div className="mt-5">
            <FriendSearch />
          </div>
          <div className="flex flex-row justify-center items-center mt-5">
            ...
            <span className="mx-2">
              ...
              {/* 아니면 열려있게 */}
              {!isPrivate && (
                <LockKeyholeOpen size={20} color="#ce47ff" strokeWidth={2.25} />
              )}
            </span>
            <span className="mx-1 ">
          ...
          <div className="w-full flex flex-row justify-between my-10 px-20">
              ...
              <div>
                {Number(maxPlayers) === Number(playerLen) ? (
                  ...
                  <>
                    ...
                    <button className="text-lg text-white mx-10 bg-gray-500 border-2 w-32 h-12 rounded ">
                      게임 시작
                    </button>
                  </>
                )}
            ...
            {showPutRoomModal && (
              <PutBurumabulRoom onClose={() => setShowPutRoomModal(false)} />
            )}
