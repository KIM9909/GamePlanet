...
const DeleteConfirmModal = ({ onClose, onConfirm, gameName }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-slate-800 rounded-lg p-6 w-[400px] transform transition-all">
        <div className="mb-6 text-center">
          ...
          <h3 className="text-xl font-semibold text-white mb-2">게임 삭제</h3>
          <p className="text-gray-400">
            <span className="font-semibold text-white">{gameName}</span>을(를)<br />
            정말 삭제하시겠습니까?
          </p>
        </div>
