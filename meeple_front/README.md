...
- 시스템 아키텍처
  ![alt text](public/SystemArchitecture.png)
- DB 설계 (ERD)
  ![alt text](public/ERD.png)
- API 설계
- WBS
  ![alt text](public/WBS.png)
- 요구사항 명세서
  ![alt text](public/require.png)

## 주요 기능

### 00. 접속 화면

![alt text](public/MainPage.gif)

### 01. 회원가입, 로그인

![alt text](public/SignUp.gif)
...
![alt text](public/TeamIntroduce.png)
